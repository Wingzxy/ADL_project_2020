...
parser.add_argument("--log-dir", default=Path("TSCNN_aug_logs"), type=Path)
...
def main(args):
    ...
    train_dataset=ConcatDataset(
        UrbanSound8KDataset('UrbanSound8K_train.pkl', "LMC", transform=transform = lambda x :spec_augment_pytorch.spec_augment(x,frequency_masking_para=85,
                         time_masking_para=41,)),
        UrbanSound8KDataset('UrbanSound8K_train.pkl', "MC", transform=transform = lambda x :spec_augment_pytorch.spec_augment(x,frequency_masking_para=85,
                         time_masking_para=41,))
    )
