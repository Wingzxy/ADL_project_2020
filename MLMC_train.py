...
parser = argparse.ArgumentParser(
    description="Train a MLMCNet on UrbanSound8KDataset",
    formatter_class=argparse.ArgumentDefaultsHelpFormatter,
)
parser.add_argument("--log-dir", default=Path("MLMC_logs"), type=Path)
...
def main(args):
    ...
    optimizer = optim.SGD(model.parameters(), lr=args.learning_rate,momentum=0.9, weight_decay=0.01)
    ...
    summary(model, input_size=(1, 145, 41))
